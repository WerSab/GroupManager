...
import { getCollection} from './firestore-Helper';
...
export function addNewMessageToCollection(message) {
    return new Promise((resolve, reject) => {
        ...
        const newMessageReference = getCollection(FIRESTORE_COLLECTION.MESSAGES).doc();
        ...
        batch.commit()
            .then(() => {
                ...
                console.log(`Added document with id ${newMessageReference.id} to message collection`)
            })
            .catch((error) => {
